...
set UKIRYU_REGISTRY=C:\path\to\register
set UKIRYU_TIMEOUT=180
set UKIRYU_DEBUG=true

# Windows PowerShell
$env:UKIRYU_REGISTRY="C:\path\to\register"
...
REGISTRY=${UKIRYU_REGISTRY:-"./register"}
TIMEOUT=${UKIRYU_TIMEOUT:-"60"}

ukiryu --register "$REGISTRY" exec inkscape export \
  inputs=drawing.svg \
  output=drawing.png \
  timeout="$TIMEOUT"
----
