...
│  (execution_profiles for platform/shell)   │
└─────────────────┬───────────────────────────┐
                  │
┌─────────────────▼───────────────────────────┐
...
* **Register**: Loads tool profiles from YAML files in hierarchical structure
* **Execution Profiles**: Define tool behavior per platform/shell combination
